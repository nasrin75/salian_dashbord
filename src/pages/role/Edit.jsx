...
import { EditValidation } from '../../validation/RoleValidation';
import Divider from '@mui/material/Divider';
import { useNavigate, useParams } from 'react-router-dom';
import { RoleDetails, updateRole } from '../../api/RoleApi';
import { APP_ROUTES } from '../../utlis/constants/routePath';

function RoleEditForm({ initialValues, onSubmit }) {
...
export default function RoleEdit() {
    ...
    const renderEdit = useMemo(() => {
        ...
        return role ? (
            <RoleEditForm initialValues={role} onSubmit={handleSubmit} />
        ) : null;
    }, [isLoading, error, role, handleSubmit]);
