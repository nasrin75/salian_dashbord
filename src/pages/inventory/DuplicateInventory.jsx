...
import DuplicateForm from '../../components/inventory/DuplicateForm';
import PageContainer from '../../components/PageContainer';
import { toast } from 'react-toastify';
import { InventoryDetails, addDuplicateInventory } from '../../api/InventoryApi';
import { EditValidation } from '../../validation/InventoryValidation';
import Divider from '@mui/material/Divider';
import { useNavigate, useParams } from 'react-router-dom';
import { APP_ROUTES } from '../../utlis/constants/routePath';

function DuplicateInventoryForm({ initialValues, onSubmit }) {
...
export default function DuplicateInventory() {
    ...
    const renderEdit = useMemo(() => {
        ...
        return inventory ? (
            <DuplicateInventoryForm initialValues={inventory} onSubmit={handleSubmit} />
        ) : null;
