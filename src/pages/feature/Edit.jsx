...
import { EditValidation } from '../../validation/FeatureValidation';
...
export default function FeatureEdit() {
    ...
    const renderEdit = useMemo(() => {
        ...
        return feature ? (
            <FeatureEditForm initialValues={feature} onSubmit={handleSubmit} />
        ) : null;
    }, [isLoading, error, feature, handleSubmit]);
